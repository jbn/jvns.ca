...
I invariably end up having to spend a bunch of time looking through my pull requests, launch emails,
design documents, and more. I always end up finding small (and sometimes not-so-small) things that I
completely forgot  I did, like:
...
through their pull requests, design docs, etc, and puts together a list of important things they did
